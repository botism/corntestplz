...
class FTX extends Component {
    ...
    componentDidMount() {
        ...
        setInterval(()=>{
            ...
            FTX.tholder.forEach((thold)=> {

                // console.log('thold..' + JSON.stringify(thold))

                let total = Math.abs(thold.size) * thold.price

                // console.log('total: ' + total)

                let signed = total * (thold.side===true?1:-1)
                ...
                t[12] =
                    ...
                    // + ' '
                    FTX.getSymbolMini(thold.symbol)
                // }
        ...
        // trade: {"channel":"trades","market":"BTC-PERP","type":"update","data":[{"id":770114,"price":10204.25,"size":0.0055,"side":"sell","liquidation":false,"time":"2019-09-20T03:30:10.544550+00:00"}]}
        ...
        const socketMessageListener = msg => {
            ...
            if (trade == null || trade.type !== 'update') {
                return
            }

            let tradeRaw = trade.data
            ...
            let symbol = trade.market.replace('-','')
            ...
            let t = {
                ...
                size: totalSize,
                timestamp: trade_.time,
                side: trade_.side==='buy',
                exchangeName: "FTX",
                startTime: Date.now(),
                amt: totalSize,
                firstPrice: firstPrice,
            ...
            // console.log('new holder ' + JSON.stringify(FTX.tholder))
        ...
        const socketOpenListener = e => {
            ...
            let ss = ['BTC-PERP', 'ETH-PERP'].forEach((symbol) => {

                let m = {'op': 'subscribe', 'channel': 'trades', 'market': symbol}
        ...
        const socketCloseListener = e => {
            ...
            setTimeout(()=>{
                ...
                this.setState({ws: new WebSocket('wss://ftx.com/ws/')})
                if (Prices.savee.FTXOn === true) {
            ...
            <div id={'exchangeDiv'}>
                ...
                <div id={'exchangeDetails'}
                    ...
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        ...
                        <img src={'images/exchange/FTX.png'} id={'exchangeIconn'} alt={'FTX'}
                             onMouseEnter={() => {
                        ...
                        <span id={'tittleee'} className={'hoverrActive'} style={{transition: '0.5s'}}>FTX</span>
                        ...
                        <div style={{padding: 4, paddingLeft: 12}}>
                            <Toggle
                                ...
                                onChange={(e) => {
                                    ...
                                    // this.state.context.set({FTXOn: e.target.checked})
                                    Prices.savee.FTXOn = e.target.checked
                ...
                <img src={'images/exchange/FTX.png'} id={'bitmexBottomIcon'} alt={'FTX'} onClick={() => {
                    ...
                    padding: 2,
                    margin: 1,
                    border: this.state.open ? '2px ridge rgba(95,255,66,0.8)' : '2px ridge rgba(255,95,66,0.8)'
                }}/>
            </div>
        )
    }
...
export default onClickOutside(FTX)
